...
class FleetManager(Node):
    def __init__(self, config, nav_path):
        ...
        @app.get('/open-rmf/project/status/',
        ...
        @app.post('/open-rmf/project/navigate/',
                  response_model=Response)
        async def navigate(robot_name: str, cmd_id: int, dest: Request):
            if self.debug:
                print(f'REACHED NAVIGATE ENDPOINT: {robot_name} {cmd_id} {dest}')
            ...
            robot = self.robots[robot_name] # TODO: check if this repetition is necessary
        ...
        @app.get('/open-rmf/project/stop_robot/',
                 response_model=Response)
        ...
        @app.post('/open-rmf/project/start_task/',
                  response_model=Response)
        ...
        @app.post('/open-rmf/project/toggle_action/',
                  response_model=Response)
